...
- [ ] STR-001 — Cargo.toml with DIG/Chia crate dependencies and metadata
...
- [ ] CON-001 — Epoch geometry constants (BLOCKS_PER_EPOCH, EPOCH_L1_BLOCKS, GENESIS_HEIGHT)
- [ ] CON-002 — Phase boundary constants (50%, 75%, 100% thresholds)
