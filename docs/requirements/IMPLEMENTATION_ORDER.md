...
- [x] STR-003 — Public re-exports (EpochManager, all types, constants, functions)
- [x] STR-004 — EpochManager constructor (new with network_id, genesis_l1_height, initial_state_root)
- [x] STR-005 — Test infrastructure (test EpochManager, test blocks, helpers)
...
- [x] CON-006 — Sentinel constants (EMPTY_ROOT)
